...
When OpenCode launches child agent sessions, ExtendAI Lab can open panes for those sessions automatically.
...
Edit `~/.config/opencode/extendai-lab.json` (or `.jsonc`):
