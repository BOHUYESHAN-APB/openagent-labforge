...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (openagent-labforge.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "openagent-labforge.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/openagent-labforge.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "openagent-labforge.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "openagent-labforge.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "openagent-labforge.jsonc"), jsoncContent, "utf-8")
