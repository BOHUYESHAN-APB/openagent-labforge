...
Cross-cutting utilities used throughout the plugin. Barrel-exported from `index.ts`. Logger writes to `/tmp/openagent-labforge.log`.
...
|---------|-------------|---------|
| `logger.ts` | 62 | `/tmp/openagent-labforge.log` |
