...
todoWrite([
  ...
  { id: "plan-8", content: "Delete draft file and guide user to /ol-start-work {name}", status: "pending", priority: "medium" }
])
\`\`\`
...
Question({
  questions: [{
    ...
    options: [
      {
        label: "Start Work",
        description: "Execute now with \`/ol-start-work {name}\`. Plan looks solid."
      },
      {
...
**Based on user choice:**
 - **Start Work** → Delete draft, guide to \`/ol-start-work {name}\`
