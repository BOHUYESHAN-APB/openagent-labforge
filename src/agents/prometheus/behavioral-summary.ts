...
Bash("rm .opencode/openagent-labforge/drafts/{name}.md")
\`\`\`
...
- Keeps .opencode/openagent-labforge/drafts/ clean for next planning session
...
- You CAN ONLY: ask questions, research, write .opencode/openagent-labforge/*.md files
