...
export function waitForSessionReady(sessionId: string, timeoutMs: number): Promise<boolean> {
...
export function findFirstMessageWithAgent(messages: unknown[]): unknown { return undefined }
export function findFirstMessageWithAgentFromSDK(messages: unknown[]): unknown { return undefined }
export function findNearestMessageWithFields(messages: unknown[], fields: Record<string, unknown>): unknown { return undefined }
export function findNearestMessageWithFieldsFromSDK(messages: unknown[], fields: Record<string, unknown>): unknown { return undefined }
export function getIsolatedSessionName(baseName: string): string { return baseName }
export interface OriginalMessageContext {
  sessionId: string
  messageId?: string
}
export function resolveMessageContext(sessionId: string): OriginalMessageContext | null { return null }
